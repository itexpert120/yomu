...
fun ReaderRoute(onBack: () -> Unit) {
    ...
    ReaderScreen(
        ...
        onOpenHighlights = viewModel::onOpenHighlights,
        onCloseHighlights = viewModel::onCloseHighlights,
        onJumpToHighlight = viewModel::onJumpToHighlight,
        onConfirmPendingHighlight = viewModel::onConfirmPendingHighlight,
        onCancelPendingHighlight = viewModel::onCancelPendingHighlight,
